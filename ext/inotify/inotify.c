...
/*
 * call-seq: 
 *    inotify_event.cookie => 0xcafebabe
 *
 */
...
void Init_inotify_native () {
	rb_mInotify = rb_define_module("Inotify");
	rb_cInotify = rb_define_class_under(rb_mInotify, "Inotify", rb_cObject);
	rb_cInotifyEvent = rb_define_class_under(rb_mInotify, "Event", rb_cObject);
	rb_const_set(rb_mInotify, rb_intern("ACCESS"), INT2NUM(IN_ACCESS));
	rb_const_set(rb_mInotify, rb_intern("MODIFY"), INT2NUM(IN_MODIFY));
	rb_const_set(rb_mInotify, rb_intern("ATTRIB"), INT2NUM(IN_ATTRIB));
	rb_const_set(rb_mInotify, rb_intern("CLOSE_WRITE"), INT2NUM(IN_CLOSE_WRITE));
	rb_const_set(rb_mInotify, rb_intern("CLOSE_NOWRITE"), INT2NUM(IN_CLOSE_NOWRITE));
	rb_const_set(rb_mInotify, rb_intern("OPEN"), INT2NUM(IN_OPEN));
	rb_const_set(rb_mInotify, rb_intern("MOVED_FROM"), INT2NUM(IN_MOVED_FROM));
	rb_const_set(rb_mInotify, rb_intern("MOVED_TO"), INT2NUM(IN_MOVED_TO));
	rb_const_set(rb_mInotify, rb_intern("CREATE"), INT2NUM(IN_CREATE));
	rb_const_set(rb_mInotify, rb_intern("DELETE"), INT2NUM(IN_DELETE));
	rb_const_set(rb_mInotify, rb_intern("DELETE_SELF"), INT2NUM(IN_DELETE_SELF));
	rb_const_set(rb_mInotify, rb_intern("MOVE_SELF"), INT2NUM(IN_MOVE_SELF));
	rb_const_set(rb_mInotify, rb_intern("UNMOUNT"), INT2NUM(IN_UNMOUNT));
	rb_const_set(rb_mInotify, rb_intern("Q_OVERFLOW"), INT2NUM(IN_Q_OVERFLOW));
	rb_const_set(rb_mInotify, rb_intern("IGNORED"), INT2NUM(IN_IGNORED));
	rb_const_set(rb_mInotify, rb_intern("CLOSE"), INT2NUM(IN_CLOSE));
	rb_const_set(rb_mInotify, rb_intern("MOVE"), INT2NUM(IN_MOVE));
	rb_const_set(rb_mInotify, rb_intern("MASK_ADD"), INT2NUM(IN_MASK_ADD));
	rb_const_set(rb_mInotify, rb_intern("ISDIR"), INT2NUM(IN_ISDIR));
	rb_const_set(rb_mInotify, rb_intern("ONESHOT"), INT2NUM(IN_ONESHOT));
	rb_const_set(rb_mInotify, rb_intern("ALL_EVENTS"), INT2NUM(IN_ALL_EVENTS));
